...
EXCEL_FILE_PATH = "preprocessed_uae_er_insurance_data_v2.xlsx"
...
if model is not None and encoders is not None:
    ...
    with col2:
        ...
        respiration_rate = st.number_input("Respiration Rate (breaths/min)", min_value=0, max_value=60, value=18)
